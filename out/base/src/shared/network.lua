...
local GlobalEvents = Networking.createEvent("base/src/shared/network@GlobalEvents")
local GlobalFunctions = Networking.createFunction("base/src/shared/network@GlobalFunctions")
return {
